...
void NeuralNetwork::DotProd(float* __restrict a, float* __restrict b, float* __restrict c, size_t a_r, size_t a_c, size_t b_r, size_t b_c, bool clear) {
...
/// @brief if clear is passed data already in c will be cleared during computation
void NeuralNetwork::DotProdTA(float* __restrict a, float* __restrict b, float* __restrict c, size_t a_r, size_t a_c, size_t b_r, size_t b_c, bool clear) {
    #pragma omp parallel for
...
/// @brief if clear is passed data already in c will be cleared during computation
void NeuralNetwork::DotProdTB(float* __restrict a, float* __restrict b, float* __restrict c, size_t a_r, size_t a_c, size_t b_r, size_t b_c, bool clear) {
    #pragma omp parallel for
	for (size_t i = 0; i < a_r; i++) {
